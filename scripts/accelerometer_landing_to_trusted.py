...
CustomerTrusted_node1765767447911 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://ayu-bucket-d609/customer/trusted/"], "recurse": True}, transformation_ctx="CustomerTrusted_node1765767447911")

# Script generated for node Accelerometer Landing
AccelerometerLanding_node1765766633540 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://ayu-bucket-d609/accelerometer/landing/"], "recurse": True}, transformation_ctx="AccelerometerLanding_node1765766633540")
...
AccelerometerTrustedZone_node1765766018921 = glueContext.getSink(path="s3://ayu-bucket-d609/accelerometer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="AccelerometerTrustedZone_node1765766018921")
