...
AccelerometerTrusted_node1765770148621 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://ayu-bucket-d609/accelerometer/trusted/"], "recurse": True}, transformation_ctx="AccelerometerTrusted_node1765770148621")

# Script generated for node Customer Trusted
CustomerTrusted_node1765770121242 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://ayu-bucket-d609/customer/trusted/"], "recurse": True}, transformation_ctx="CustomerTrusted_node1765770121242")
...
CustomerCurated_node1765770347903 = glueContext.getSink(path="s3://ayu-bucket-d609/customer/curated/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="CustomerCurated_node1765770347903")
