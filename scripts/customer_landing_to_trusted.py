...
CustomerLanding_node1765766633540 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://ayu-bucket-d609/customer/landing/"], "recurse": True}, transformation_ctx="CustomerLanding_node1765766633540")
...
CustomerTrustedZone_node1765766018921 = glueContext.getSink(path="s3://ayu-bucket-d609/customer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="CustomerTrustedZone_node1765766018921")
