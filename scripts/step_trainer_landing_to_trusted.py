...
StepTrainerLanding_node1765770148621 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://ayu-bucket-d609/step_trainer/landing/"], "recurse": True}, transformation_ctx="StepTrainerLanding_node1765770148621")

# Script generated for node Customer Curated
CustomerCurated_node1765770121242 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://ayu-bucket-d609/customer/curated/"], "recurse": True}, transformation_ctx="CustomerCurated_node1765770121242")
...
StepTrainerTrustedZone_node1765770347903 = glueContext.getSink(path="s3://ayu-bucket-d609/step_trainer/trusted/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="StepTrainerTrustedZone_node1765770347903")
